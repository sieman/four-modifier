;;; +modifier.el --- Meta Control Hyper Super :key:binding: -*- lexical-binding: t; -*-
;;
;; Copyright (C) 2021 Siegmar Mantei
;;
;; Author: Siegmar Mantei <https://github.com/siemam>
;; Maintainer: Siegmar Mantei <post@smantei.net>
;; Created: Juni 02, 2021
;; Modified: Juni 02, 2021
;; Version: 0.0.1
;; Keywords: Symbol’s value as variable is void: finder-known-keywords
;; Homepage: https://github.com/sim/+modifier
